...
> 内容来自：https://github.com/sparanoid/chinese-copywriting-guidelines

统一中文文案、排版的相关用法，降低团队成员之间的沟通成本。所以请严格遵守下面的规范：

- 文档统一采用 Markdown 编写，[Markdown 语法](doc/markdown.md)
- 排版风格请严格遵守下面的**中文文案排版指南**
